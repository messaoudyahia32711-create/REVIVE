...
export default function Home() {
  ...
  const showFooter = !['user-dashboard', 'provider-dashboard'].includes(currentPage);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <AnimatePresence>
        {toastMessage && (
          ...
          >
            <div
              className={`rounded-xl px-5 py-3.5 shadow-2xl border cursor-pointer flex items-center gap-3 ${
                toastType === 'success'
